...
set(PROOT_C_FLAGS "${CMAKE_C_FLAGS} -I${TALLOC_INCLUDE_DIRS} -I${PROOT_SRC} -D_GNU_SOURCE")
set(PROOT_LINKER_FLAGS "-L${TALLOC_BIN}/lib -static -ltalloc")
...
ExternalProject_Add(
        ...
        GIT_SHALLOW 1
        CONFIGURE_COMMAND ""
        BUILD_COMMAND cd ${PROOT_SRC} && make V=1 CC=${PROOT_C_COMPILER} LD=${PROOT_C_COMPILER} STRIP=${CMAKE_STRIP} OBJCOPY=${CMAKE_OBJCOPY} OBJDUMP=${CMAKE_OBJDUMP} CPPFLAGS=${CMAKE_CXX_FLAGS} CFLAGS=${PROOT_C_FLAGS} LDFLAGS=${PROOT_LINKER_FLAGS}
